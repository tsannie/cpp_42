...
/*   Updated: 2021/09/06 15:42:43 by tsannie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string		ClapTrap::getName() const { return(this->ClapTrap::_name); }

unsigned int	ClapTrap::getHit() const { return(this->ClapTrap::_hit); }

unsigned int	ClapTrap::getEnergy() const { return(this->ClapTrap::_energy); }

unsigned int	ClapTrap::getAttack() const { return(this->ClapTrap::_attack); }
